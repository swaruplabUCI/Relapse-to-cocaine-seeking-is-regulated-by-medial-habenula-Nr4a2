...
check the reinstatement dataset 

```{r eval=FALSE}

seurat_re <- readRDS("/dfs7/swaruplab/smorabit/collab/woodlab/reinstatement_2022/data/Reinstatement_2022_seurat.rds")



p1 <- FeatureEmbedding(
  seurat_re %>% subset(Group == 'Reinstatement'),
  'Nr4a2',
  same_range=FALSE,
  plot_max=4,
  plot_min=0,
...
pdf(paste0(fig_dir, 'Nr4a2_featureplot_reinstatement.pdf'), width=5, height=8)
patch
dev.off()
...
pdf(paste0(fig_dir, 'Nr4a2_vln_clusters2.pdf'), width=7.5, height=4.5)
p
dev.off()
