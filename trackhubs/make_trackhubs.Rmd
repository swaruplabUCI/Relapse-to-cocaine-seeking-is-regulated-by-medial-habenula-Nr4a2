...
Seurat object, to make a bigwig track for each cell group that we can view
...
## Step 3: write list of files to combine using samtools
...
track ODC_1_NURR2C
bigDataUrl ODC_1_NURR2C.bigWig
shortLabel ODC_1_NURR2C
longLabel OODC_1_NURR2C
type bigWig
visibility full
color 255,171,255
autoScale on
